  ...
  return (
   <div className="flex items-center justify-center min-h-screen text-gray-300">
      <div className="w-full max-w-2xl p-8 rounded-lg shadow-lg bg-base-200 my-24">
        <h2 className="text-2xl font-bold text-center text-primary">SignUp</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white py-2 rounded-md  hover:bg-[#4c4acc] transition duration-200 cursor-pointer"
          >
            Create Account
          </button>
        </form>
