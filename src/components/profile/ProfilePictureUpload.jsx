...
const ProfilePictureUpload = ({ user }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(BASE_URL + "/profile/upload-profile", formData, {
  ...
  const handleRemoveProfile = async ()=>{
    try{
      const response = axios.delete(BASE_URL + '/profile/remove-profile', {withCredentials:true});
      dispatch(
        setUser({
          ...user,
          profilePicture:
